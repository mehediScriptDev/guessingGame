...
export default function Result({ result, round, ROUNDS, nextRound, bgBottom, navbar, dark }) {
  ...
  return (
    ...
    >
      {navbar}
      <div className="relative z-20 flex-1 flex flex-col items-center justify-start w-full max-w-190 mx-auto px-4 sm:px-6 pb-10 sm:pb-20 text-center mt-8 sm:mt-18">
